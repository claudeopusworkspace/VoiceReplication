"""Harness adapter for GPT-SoVITS v2Pro — fine-tuned on the Diana character."""
import argparse
import os
import sys
import time
...
def main():
    ...
    for i, row in enumerate(rows):
        try:
            ...
            emit("gpt-sovits-v2Pro-ft", row, status="fail", error=f"{type(e).__name__}: {e}")
